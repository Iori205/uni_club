...
/** `<ToastProvider>` доторх хаанаас ч `showToast("...", "success" | "error")` дуудна — apps/web-тэй ижил API/motion. */
  ...
  return (
    <ToastContext.Provider value={{ showToast }}>
      ...
      <div
        ...
        className="pointer-events-none fixed inset-x-4 bottom-4 z-[60] flex flex-col items-center gap-2 [bottom:max(1rem,env(safe-area-inset-bottom))] sm:inset-x-auto sm:right-4 sm:items-end"
      >
        {toasts.map((toast) => (
          <ToastCard
            key={toast.id}
